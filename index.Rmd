...
dat <- read.table("/Users/aazman/Documents/D4D/trunk/data/POS_SAMPLE_0.TSV",sep="\t",nrows=10000)
dat <- dat[-which(dat[,3] == -1),]
colnames(dat) <- c("id","call.date.time","call.tower")
head(dat[sample(nrow(dat),10),])
```
